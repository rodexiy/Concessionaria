...
//                case 13 -> removerCliente();
//                case 14 -> editarCliente();
...
//
//        try {
//            logado = Cliente.login(cpf, senha);
...
//        }
//
//        Cliente novoCliente = menuCadastrarCliente();
//        ((Gerente) logado).editarUmCliente(novoCliente);
...
//        Cliente cliente = menuCadastrarCliente();
//
//        if (cliente != null) {
//            ((Gerente) logado).cadastrarCliente(cliente);
//        }
//    }
//
//    public static Cliente menuCadastrarCliente() {
//        System.out.println("""
//                Que tipo de cliente deseja cadastrar/editar:
//                1 - Cliente:
//                2 - Vendedor:
//                """);
//
...
//            case 1 -> {
//                String cnh = pedirCNH();
//                cliente = new Cliente(nome, cpf, senha, cnh);
//            }
//            case 2 -> {
//                System.out.println("Insira o salario do cliente: ");
...
//        String cpf = pedirCPF();
//        System.out.println(((Gerente) logado).removerCliente(cpf));
//    }
//
...
//        String cpf = pedirCPF();
//        Cliente vendedor = Cliente.getCliente(cpf);
//
//        if (vendedor == null) {
